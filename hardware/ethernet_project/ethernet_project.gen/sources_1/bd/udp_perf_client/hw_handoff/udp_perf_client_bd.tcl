...
################################################################
# This is a generated script based on design: udp_perf_client
#
...
# source udp_perf_client_script.tcl
...
set design_name udp_perf_client
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_S2MM [get_bd_intf_pins axi_dma_0/M_AXI_S2MM] [get_bd_intf_pins smartconnect_0/S04_AXI]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_SG [get_bd_intf_pins axi_dma_0/M_AXI_SG] [get_bd_intf_pins smartconnect_0/S05_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins microblaze_0_axi_intc/s_axi] [get_bd_intf_pins smartconnect_0/M01_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M04_AXI [get_bd_intf_pins axi_dma_0/S_AXI_LITE] [get_bd_intf_pins smartconnect_0/M04_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M05_AXI [get_bd_intf_pins axi_ethernet_0/s_axi] [get_bd_intf_pins smartconnect_0/M05_AXI]
  ...
  connect_bd_net -net axi_ethernet_0_phy_rst_n [get_bd_ports ETH_RSTN] [get_bd_pins axi_ethernet_0/phy_rst_n] [get_bd_pins mii_to_rmii_0/rst_n]
  ...
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins cpu_sys_reset/dcm_locked]
  connect_bd_net -net cpu_sys_reset_bus_struct_reset [get_bd_pins cpu_sys_reset/bus_struct_reset] [get_bd_pins microblaze_0_local_memory/SYS_Rst]
  connect_bd_net -net cpu_sys_reset_interconnect_aresetn [get_bd_pins cpu_sys_reset/interconnect_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins cpu_sys_reset/mb_debug_sys_rst] [get_bd_pins mdm_1/Debug_SYS_Rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_ethernet_0/axis_clk] [get_bd_pins axi_ethernet_0/s_axi_lite_clk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins cpu_sys_reset/slowest_sync_clk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mig_7series_0/sys_clk_i] [get_bd_pins smartconnect_0/aclk]
  connect_bd_net -net microblaze_0_intr [get_bd_pins microblaze_0_axi_intc/intr] [get_bd_pins microblaze_0_xlconcat/dout]
  connect_bd_net -net mig_7series_0_mmcm_locked [get_bd_pins fpga_sys_reset/dcm_locked] [get_bd_pins mig_7series_0/mmcm_locked]
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins fpga_sys_reset/slowest_sync_clk] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins smartconnect_0/aclk1]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins fpga_sys_reset/peripheral_aresetn] [get_bd_pins mig_7series_0/aresetn]
  connect_bd_net -net resetn_0_1 [get_bd_ports CPU_RESETN] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins cpu_sys_reset/ext_reset_in] [get_bd_pins fpga_sys_reset/ext_reset_in] [get_bd_pins mig_7series_0/sys_rst]
  connect_bd_net -net rst_clk_wiz_0_100M_mb_reset [get_bd_pins cpu_sys_reset/mb_reset] [get_bd_pins microblaze_0/Reset] [get_bd_pins microblaze_0_axi_intc/processor_rst]
  connect_bd_net -net rst_clk_wiz_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_ethernet_0/s_axi_lite_resetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins cpu_sys_reset/peripheral_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn]

  # Create address segments
  assign_bd_address -offset 0x80000000 -range 0x08000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_SG] [get_bd_addr_segs mig_7series_0/memmap/memaddr] -force
  ...
  assign_bd_address -offset 0x40C00000 -range 0x00040000 -target_address_space [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs axi_ethernet_0/s_axi/Reg0] -force
  ...
  exclude_bd_addr_seg -offset 0x40C00000 -range 0x00040000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs axi_ethernet_0/s_axi/Reg0]
  ...
  exclude_bd_addr_seg -offset 0x40C00000 -range 0x00040000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs axi_ethernet_0/s_axi/Reg0]
  ...
  exclude_bd_addr_seg -offset 0x40C00000 -range 0x00040000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_SG] [get_bd_addr_segs axi_ethernet_0/s_axi/Reg0]
