...
set_max_delay -from [get_cells {bd_bfe0_mac_0_core/flow/rx_pause/pause*to_tx_reg[*]}] -to [get_cells {bd_bfe0_mac_0_core/flow/tx_pause/count_set*reg}] 32 -datapath_only
set_max_delay -from [get_cells {bd_bfe0_mac_0_core/flow/rx_pause/pause*to_tx_reg[*]}] -to [get_cells {bd_bfe0_mac_0_core/flow/tx_pause/pause_count*reg[*]}] 32 -datapath_only
set_max_delay -from [get_cells {bd_bfe0_mac_0_core/flow/rx_pause/pause_req_to_tx_int_reg}] -to [get_cells {bd_bfe0_mac_0_core/flow/tx_pause/sync_good_rx/data_sync_reg0}] 6 -datapath_only

# false path due to synced control path
set_max_delay -from [get_cells {bd_bfe0_mac_0_core/*statistics_counters/rd_data_ref_reg[*]}] -to [get_cells {bd_bfe0_mac_0_core/*statistics_counters/ip2bus_data_reg[*]}] 6 -datapath_only
# CDC from the Tx and Rx statistics to the statistic counter logic
set_max_delay -from [get_cells {vector_decode_inst/inc_vector_reg[*]}] -to [get_cells {bd_bfe0_mac_0_core/*statistics_counters/general_statisic_control[*].general_statisics/sync_inc_vector/data_sync_reg0}] 6 -datapath_only
set_max_delay -from [get_cells {vector_decode_inst/inc_vector_reg[*]}] -to [get_cells {bd_bfe0_mac_0_core/*statistics_counters/frame_size_bin_control1[*].frame_size_stats1/sync_inc_vector/data_sync_reg0}] 6 -datapath_only
set_max_delay -from [get_cells {vector_decode_inst/inc_vector_reg[*]}] -to [get_cells {bd_bfe0_mac_0_core/*statistics_counters/frame_size_bin_control2[*].frame_size_stats2/sync_inc_vector/data_sync_reg0}] 6 -datapath_only
set_max_delay -from [get_cells {bd_bfe0_mac_0_core/*statistics_counters/*/accumulator_gray_reg[*]}] -to [get_cells {bd_bfe0_mac_0_core/*statistics_counters/*/accum_gray_resync[*].sync_accum_gray_i/data_sync_reg0}] 6 -datapath_only
set_max_delay -from [get_cells {bd_bfe0_mac_0_core/*statistics_counters/response_toggle_reg}] -to [get_cells {bd_bfe0_mac_0_core/*statistics_counters/sync_response/data_sync_reg0}] 6 -datapath_only
set_max_delay -from [get_cells {bd_bfe0_mac_0_core/*statistics_counters/request_toggle_reg}] -to [get_cells {bd_bfe0_mac_0_core/*statistics_counters/sync_request/data_sync_reg0}] 6 -datapath_only
...
set_max_delay -from [get_cells {bd_bfe0_mac_0_core/addr_filter_top/addr_regs.promiscuous_mode_reg_reg}] -to [get_cells {bd_bfe0_mac_0_core/addr_filter_top/address_filter_inst/resync_promiscuous_mode/data_sync_reg0}] 6 -datapath_only
set_max_delay -from [get_cells {bd_bfe0_mac_0_core/addr_filter_top/addr_regs.filter_enable_reg_reg[*]}] -to [get_cells {bd_bfe0_mac_0_core/addr_filter_top/address_filter_inst/address_filters[*].sync_enable/data_sync_reg0}] 6 -datapath_only
set_max_delay -from [get_cells {bd_bfe0_mac_0_core/*managen/conf/update_pause_ad_int_reg}] -to [get_cells {bd_bfe0_mac_0_core/addr_filter_top/address_filter_inst/sync_update/data_sync_reg0}] 6 -datapath_only
...
set_false_path -from [get_cells -hierarchical -filter {NAME =~ *bd_bfe0_mac_0_core/addr_filter_top/address_filter_inst/*/DP}] -to  [get_cells -hierarchical -filter {NAME =~ *bd_bfe0_mac_0_core/addr_filter_top/address_filter_inst/*addr*/bit_match*reg[*]}]
...
set_multicycle_path 10 -setup -from [get_cells {bd_bfe0_mac_0_core/*managen/mdio_enabled.miim_clk_int_reg}  ] -throu [get_ports mdc]
set_multicycle_path 9 -hold -from   [get_cells {bd_bfe0_mac_0_core/*managen/mdio_enabled.miim_clk_int_reg}  ] -throu [get_ports mdc]
set_multicycle_path 10 -setup -from [get_cells {bd_bfe0_mac_0_core/*managen/mdio_enabled.phy/enable_reg_reg}] -throu [get_ports mdc]
set_multicycle_path 9 -hold -from   [get_cells {bd_bfe0_mac_0_core/*managen/mdio_enabled.phy/enable_reg_reg}] -throu [get_ports mdc]
set_multicycle_path 10 -setup -from [get_cells {bd_bfe0_mac_0_core/*managen/mdio_enabled.phy/mdio*reg}      ] -throu [get_ports mdio_o ] 
set_multicycle_path 9 -hold -from   [get_cells {bd_bfe0_mac_0_core/*managen/mdio_enabled.phy/mdio*reg}      ] -throu [get_ports mdio_o ] 
set_multicycle_path 10 -setup -from [get_cells {bd_bfe0_mac_0_core/*managen/mdio_enabled.phy/mdio*reg}      ] -throu [get_ports mdio_t ] 
set_multicycle_path 9 -hold -from   [get_cells {bd_bfe0_mac_0_core/*managen/mdio_enabled.phy/mdio*reg}      ] -throu [get_ports mdio_t ] 
