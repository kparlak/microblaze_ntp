...
################################################################
# This is a generated script based on design: bd_65d7
#
...
proc create_hier_cell_switchboards { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.M04_S05_CONNECTIVITY {0} \
   CONFIG.M05_S00_CONNECTIVITY {1} \
   CONFIG.M05_S01_CONNECTIVITY {1} \
   CONFIG.M05_S02_CONNECTIVITY {1} \
   CONFIG.M05_S03_CONNECTIVITY {0} \
   CONFIG.M05_S04_CONNECTIVITY {0} \
...
proc create_hier_cell_s02_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SEG000_SUPPORTS_READ {1} \
   CONFIG.SEG000_SUPPORTS_WRITE {1} \
   CONFIG.SEG001_BASE_ADDR {0x0000000040C00000} \
   ...
   CONFIG.SEG002_BASE_ADDR {0x0000000041200000} \
   ...
   CONFIG.SEG003_BASE_ADDR {0x0000000041C00000} \
   ...
   CONFIG.SEG004_BASE_ADDR {0x0000000041E00000} \
   ...
   CONFIG.SEG005_BASE_ADDR {0x0000000080000000} \
...
proc create_hier_cell_m05_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.RDATA_WIDTH {32} \
   CONFIG.READ_WRITE_MODE {READ_WRITE} \
   CONFIG.SSC000_ROUTE {0b000000} \
   CONFIG.SSC001_ROUTE {0b000000} \
   CONFIG.SSC002_ROUTE {0b000000} \
   CONFIG.SSC003_ROUTE {0b000000} \
   CONFIG.SSC004_ROUTE {0b100000} \
   CONFIG.SSC005_ROUTE {0b001000} \
   CONFIG.SSC006_ROUTE {0b010000} \
   CONFIG.SSC007_ROUTE {0b000001} \
   CONFIG.SSC008_ROUTE {0b000010} \
   CONFIG.SSC009_ROUTE {0b000100} \
   CONFIG.SSC010_ROUTE {0b000000} \
   CONFIG.SSC011_ROUTE {0b000000} \
   CONFIG.SSC012_ROUTE {0b000000} \
   CONFIG.SSC013_ROUTE {0b000000} \
   CONFIG.SSC014_ROUTE {0b000000} \
   CONFIG.SSC015_ROUTE {0b000000} \
...
proc create_hier_cell_clk_map { parentCell nameHier } {
  ...
  connect_bd_net -net clk_map_aclk_net [get_bd_pins M01_ACLK] [get_bd_pins M02_ACLK] [get_bd_pins M03_ACLK] [get_bd_pins M04_ACLK] [get_bd_pins M05_ACLK] [get_bd_pins S00_ACLK] [get_bd_pins S01_ACLK] [get_bd_pins S02_ACLK] [get_bd_pins S03_ACLK] [get_bd_pins S04_ACLK] [get_bd_pins S05_ACLK] [get_bd_pins aclk] [get_bd_pins swbd_aclk] [get_bd_pins psr_aclk/slowest_sync_clk]
  ...
  connect_bd_net -net psr_aclk_interconnect_aresetn [get_bd_pins M01_ARESETN] [get_bd_pins M02_ARESETN] [get_bd_pins M03_ARESETN] [get_bd_pins M04_ARESETN] [get_bd_pins M05_ARESETN] [get_bd_pins S00_ARESETN] [get_bd_pins S01_ARESETN] [get_bd_pins S02_ARESETN] [get_bd_pins S03_ARESETN] [get_bd_pins S04_ARESETN] [get_bd_pins S05_ARESETN] [get_bd_pins swbd_aresetn] [get_bd_pins psr_aclk/interconnect_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {M01_AXI:M02_AXI:M03_AXI:M04_AXI:M05_AXI:S00_AXI:S01_AXI:S02_AXI:S03_AXI:S04_AXI:S05_AXI} \
 ] $aclk
  ...
  connect_bd_intf_net -intf_net S_SC_AR_7 [get_bd_intf_pins m01_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M01_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_8 [get_bd_intf_pins m02_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M02_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_9 [get_bd_intf_pins m03_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M03_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_10 [get_bd_intf_pins m04_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M04_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_11 [get_bd_intf_pins m05_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M05_SC_AR]
  ...
  connect_bd_intf_net -intf_net S_SC_AW_6 [get_bd_intf_pins m01_nodes/S_SC_AW] [get_bd_intf_pins switchboards/M01_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_7 [get_bd_intf_pins m02_nodes/S_SC_AW] [get_bd_intf_pins switchboards/M02_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_8 [get_bd_intf_pins m03_nodes/S_SC_AW] [get_bd_intf_pins switchboards/M03_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_9 [get_bd_intf_pins m04_nodes/S_SC_AW] [get_bd_intf_pins switchboards/M04_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_10 [get_bd_intf_pins m05_nodes/S_SC_AW] [get_bd_intf_pins switchboards/M05_SC_AW]
  ...
  connect_bd_intf_net -intf_net S_SC_B_6 [get_bd_intf_pins m01_nodes/S_SC_B] [get_bd_intf_pins m01_sc2axi/M_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_7 [get_bd_intf_pins m02_nodes/S_SC_B] [get_bd_intf_pins m02_sc2axi/M_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_8 [get_bd_intf_pins m03_nodes/S_SC_B] [get_bd_intf_pins m03_sc2axi/M_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_9 [get_bd_intf_pins m04_nodes/S_SC_B] [get_bd_intf_pins m04_sc2axi/M_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_10 [get_bd_intf_pins m05_nodes/S_SC_B] [get_bd_intf_pins m05_sc2axi/M_SC_B]
  ...
  connect_bd_intf_net -intf_net S_SC_R_7 [get_bd_intf_pins m01_nodes/S_SC_R] [get_bd_intf_pins m01_sc2axi/M_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_8 [get_bd_intf_pins m02_nodes/S_SC_R] [get_bd_intf_pins m02_sc2axi/M_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_9 [get_bd_intf_pins m03_nodes/S_SC_R] [get_bd_intf_pins m03_sc2axi/M_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_10 [get_bd_intf_pins m04_nodes/S_SC_R] [get_bd_intf_pins m04_sc2axi/M_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_11 [get_bd_intf_pins m05_nodes/S_SC_R] [get_bd_intf_pins m05_sc2axi/M_SC_R]
  ...
  connect_bd_intf_net -intf_net S_SC_W_6 [get_bd_intf_pins m01_nodes/S_SC_W] [get_bd_intf_pins switchboards/M01_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_7 [get_bd_intf_pins m02_nodes/S_SC_W] [get_bd_intf_pins switchboards/M02_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_8 [get_bd_intf_pins m03_nodes/S_SC_W] [get_bd_intf_pins switchboards/M03_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_9 [get_bd_intf_pins m04_nodes/S_SC_W] [get_bd_intf_pins switchboards/M04_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_10 [get_bd_intf_pins m05_nodes/S_SC_W] [get_bd_intf_pins switchboards/M05_SC_W]
  ...
  connect_bd_net -net swbd_aclk_net [get_bd_pins clk_map/swbd_aclk] [get_bd_pins m00_nodes/s_axi_aclk] [get_bd_pins m01_nodes/s_axi_aclk] [get_bd_pins m02_nodes/s_axi_aclk] [get_bd_pins m03_nodes/s_axi_aclk] [get_bd_pins m04_nodes/s_axi_aclk] [get_bd_pins m05_nodes/s_axi_aclk] [get_bd_pins s00_nodes/m_sc_clk] [get_bd_pins s01_nodes/m_sc_clk] [get_bd_pins s02_nodes/m_sc_clk] [get_bd_pins s03_nodes/m_sc_clk] [get_bd_pins s04_nodes/m_sc_clk] [get_bd_pins s05_nodes/m_sc_clk] [get_bd_pins switchboards/aclk]
  connect_bd_net -net swbd_aresetn_net [get_bd_pins clk_map/swbd_aresetn] [get_bd_pins m00_nodes/s_axi_aresetn] [get_bd_pins m01_nodes/s_axi_aresetn] [get_bd_pins m02_nodes/s_axi_aresetn] [get_bd_pins m03_nodes/s_axi_aresetn] [get_bd_pins m04_nodes/s_axi_aresetn] [get_bd_pins m05_nodes/s_axi_aresetn] [get_bd_pins s00_nodes/m_sc_resetn] [get_bd_pins s01_nodes/m_sc_resetn] [get_bd_pins s02_nodes/m_sc_resetn] [get_bd_pins s03_nodes/m_sc_resetn] [get_bd_pins s04_nodes/m_sc_resetn] [get_bd_pins s05_nodes/m_sc_resetn] [get_bd_pins switchboards/aresetn]
