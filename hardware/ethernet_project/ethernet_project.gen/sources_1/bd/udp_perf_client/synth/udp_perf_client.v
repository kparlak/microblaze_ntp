...
//Command     : generate_target udp_perf_client.bd
//Design      : udp_perf_client
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module microblaze_0_local_memory_imp_1PAIIX1
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > udp_perf_client microblaze_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  udp_perf_client_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  udp_perf_client_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_dlmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_dlmb_bus_BE),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  udp_perf_client_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
  ...
  udp_perf_client_ilmb_v10_0 ilmb_v10
       (.LMB_ABus(microblaze_0_ilmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_ilmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_ilmb_bus_BE),
        ...
        .Sl_UE(microblaze_0_ilmb_bus_UE),
        .Sl_Wait(microblaze_0_ilmb_bus_WAIT));
  udp_perf_client_lmb_bram_0 lmb_bram
...
(* CORE_GENERATION_INFO = "udp_perf_client,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=udp_perf_client,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=20,numReposBlks=19,numNonXlnxBlks=0,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_aeth_cnt=1,da_axi4_cnt=5,da_board_cnt=4,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "udp_perf_client.hwdef" *) 
module udp_perf_client
   (CLK100MHZ,
    CPU_RESETN,
    ETH_REFCLK,
    ETH_RSTN,
    ...
    usb_uart_rxd,
    usb_uart_txd);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK100MHZ CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK100MHZ, CLK_DOMAIN udp_perf_client_CLK100MHZ, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000" *) input CLK100MHZ;
  ...
  wire [0:0]cpu_sys_reset_bus_struct_reset;
  wire [0:0]cpu_sys_reset_interconnect_aresetn;
  ...
  wire [17:0]smartconnect_0_M05_AXI_ARADDR;
  wire smartconnect_0_M05_AXI_ARREADY;
  wire smartconnect_0_M05_AXI_ARVALID;
  wire [17:0]smartconnect_0_M05_AXI_AWADDR;
  ...
  assign ETH_RSTN[0] = axi_ethernet_0_phy_rst_n;
  ...
  udp_perf_client_axi_dma_0_0 axi_dma_0
  ...
  udp_perf_client_axi_ethernet_0_0 axi_ethernet_0
  ...
  udp_perf_client_axi_timer_0_0 axi_timer_0
       (.capturetrig0(1'b0),
        .capturetrig1(1'b0),
        .freeze(1'b0),
  ...
  udp_perf_client_axi_uartlite_0_0 axi_uartlite_0
  ...
  udp_perf_client_clk_wiz_0_0 clk_wiz_0
       (.clk_in1(clk_in1_0_1),
        ...
        .resetn(resetn_0_1));
  udp_perf_client_cpu_sys_reset_0 cpu_sys_reset
       (.aux_reset_in(1'b1),
        .bus_struct_reset(cpu_sys_reset_bus_struct_reset),
        .dcm_locked(clk_wiz_0_locked),
        .ext_reset_in(resetn_0_1),
        .interconnect_aresetn(cpu_sys_reset_interconnect_aresetn),
        .mb_debug_sys_rst(mdm_1_debug_sys_rst),
        .mb_reset(rst_clk_wiz_0_100M_mb_reset),
        .peripheral_aresetn(rst_clk_wiz_0_100M_peripheral_aresetn),
        .slowest_sync_clk(microblaze_0_Clk));
  udp_perf_client_fpga_sys_reset_0 fpga_sys_reset
       (.aux_reset_in(1'b1),
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > udp_perf_client microblaze_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  udp_perf_client_microblaze_0_0 microblaze_0
  ...
  udp_perf_client_microblaze_0_axi_intc_0 microblaze_0_axi_intc
  ...
  microblaze_0_local_memory_imp_1PAIIX1 microblaze_0_local_memory
       (.DLMB_abus(microblaze_0_dlmb_1_ABUS),
        ...
        .LMB_Clk(microblaze_0_Clk),
        .SYS_Rst(cpu_sys_reset_bus_struct_reset));
  udp_perf_client_microblaze_0_xlconcat_0 microblaze_0_xlconcat
  ...
  udp_perf_client_mig_7series_0_0 mig_7series_0
  ...
  udp_perf_client_mii_to_rmii_0_1 mii_to_rmii_0
       (.mac2rmii_tx_en(axi_ethernet_0_mii_TX_EN),
        ...
        .rst_n(axi_ethernet_0_phy_rst_n));
  udp_perf_client_smartconnect_0_0 smartconnect_0
       (.M00_AXI_araddr(smartconnect_0_M00_AXI_ARADDR),
        ...
        .aresetn(cpu_sys_reset_interconnect_aresetn));
endmodule
