...
HD_PWD='C:/Data/en.525.612/Parlak_Project/hardware/ethernet_project/ethernet_project.runs/bd_ae0d_mac_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_ae0d_mac_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_ae0d_mac_0.tcl
