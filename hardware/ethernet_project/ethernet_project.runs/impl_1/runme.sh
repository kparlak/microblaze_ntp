...
HD_PWD='C:/Data/en.525.612/Parlak_Project/hardware/ethernet_project/ethernet_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log network_clock_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source network_clock_wrapper.tcl -notrace
