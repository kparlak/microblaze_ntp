...
HD_PWD='C:/Data/en.525.612/Parlak_Project/hardware/ethernet_project/ethernet_project.runs/network_clock_axi_gpio_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log network_clock_axi_gpio_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source network_clock_axi_gpio_0_3.tcl
