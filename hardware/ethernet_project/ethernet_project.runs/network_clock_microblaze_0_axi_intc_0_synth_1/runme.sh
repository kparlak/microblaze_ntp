...
HD_PWD='C:/Data/en.525.612/Parlak_Project/hardware/ethernet_project/ethernet_project.runs/network_clock_microblaze_0_axi_intc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log network_clock_microblaze_0_axi_intc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source network_clock_microblaze_0_axi_intc_0.tcl
